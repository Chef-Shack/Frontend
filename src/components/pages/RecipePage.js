...
const RecipePage = () => {
  ...
  function likeButtonHandler() {
    if (!starImage) {
      if (window.localStorage.getItem("authenticated")) {
        ...
        axios
          .post("https://chefshack-backend.herokuapp.com/members/like_recipe", bodyFormData)
          .catch((err) => {
            console.log(err);
          });
      }
      ...
      if (window.localStorage.getItem("authenticated")) {
        ...
        axios
          .post("https://chefshack-backend.herokuapp.com/members/unlike_recipe", bodyFormData)
          .catch((err) => {
            console.log(err);
          });
      }
  ...
  useEffect(() => {
    function getRecipe() {
      ...
      axios
        .post("https://chefshack-backend.herokuapp.com/recipes/get_recipe", bodyFormData)
        .then((res) => {
    ...
    function checkIfRecipeIsLiked() {
      ...
      axios
        .get(`https://chefshack-backend.herokuapp.com/members/get_user_by_name/${username}`)
        .then((res) => {
